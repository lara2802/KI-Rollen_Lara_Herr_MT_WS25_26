...
# Settings & Parameters
BETA_MIN <- 0.10 # Minimal detectable path coefficient
BETA_ERROR_PROB <- 0.20
POWER_TARGET <- 1 - BETA_ERROR_PROB # 0.80
SIGNIFICANCE <- 0.05

EFFECT_SIZE_F2 <- 0.02 # Small effect (Cohen, 1988)
...
cat("  - Min. Path Coeff (beta_min):", BETA_MIN, "(Minimal)\n")
cat("  - Effect Size (f^2):", EFFECT_SIZE_F2, "(Small)\n")
